...
void ::SoundCapture::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::SoundCapture::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    switch (__connectionId)
    {
        case 1:
            {
                this->label1 = safe_cast<::Windows::UI::Xaml::Controls::TextBlock^>(__target);
            }
            break;
        case 2:
            {
                this->label2 = safe_cast<::Windows::UI::Xaml::Controls::TextBlock^>(__target);
            }
            break;
        case 3:
            {
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::SoundCapture::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
